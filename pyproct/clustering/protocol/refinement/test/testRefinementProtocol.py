...
class Test(unittest.TestCase):
    ...
    def test_redefine_cluster_with_map(self):
        ...
        self.assertCountEqual( [1,3,8],Refiner.redefine_cluster_with_map(initial_cluster, final_cluster_1).all_elements)
        self.assertCountEqual( [4,7],Refiner.redefine_cluster_with_map(initial_cluster, final_cluster_2).all_elements)
    ...
    def test_repartition_with_kmedoids(self):
        ...
        self.assertCountEqual( [1,3,8],clustering.clusters[0])
        self.assertCountEqual( [4,7],clustering.clusters[1])
